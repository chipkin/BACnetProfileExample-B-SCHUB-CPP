...
// Optional: certificate revocation lists (PEM, one or more - one per issuer)
// from the site's CA. When present, a device whose certificate is on a list is
// refused (issue #15). Never written by the hub or --generate-certs.
